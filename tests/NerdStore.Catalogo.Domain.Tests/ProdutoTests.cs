...
namespace NerdStore.Catalogo.Domain.Tests
{
    public class ProdutoTests
    {
        ...
        public void Produto_Validar_ValidacoesDevemRetornarExceptions()
        {
            ...
            ex = Assert.Throws<DomainException>(() => new Produto("Nome", "Descricao", false, 0, Guid.NewGuid(), DateTime.Now, "imagem", new Dimensoes(1, 1, 1)));
            ...
            ex = Assert.Throws<DomainException>(() => new Produto("Nome", "Descricao", false, 100, Guid.NewGuid(), DateTime.Now, "imagem", new Dimensoes(0, 1, 1)));
